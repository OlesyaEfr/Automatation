...
class Company:
    ...
    def create_company(self, name, description=''):
        ...
        resp = requests.post(
            f"{self.url}/company", json=company, headers=my_headers)
        return resp.json()
    ...
    def add_new_employee(self, new_id, name, last_name):
        employee = {
            ...
            "url": "string",
            "phone": "89990000000",
            "birthdate": "2024-09-07T18:54:13.783Z",
            "isActive": 'true'
        }
        ...
        my_headers["x-client-token"] = self.get_token()
        resp = requests.post(
            f"{self.url}/employee", headers=my_headers, json=employee)
        return resp.json()
    ...
    def update_employee_info(self, id_employee, last_name, email):
        ...
        my_headers["x-client-token"] = self.get_token()
        resp = requests.patch(
            f"{self.url}/employee/{id_employee}",
